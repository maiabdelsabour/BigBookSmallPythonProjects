...
#A list of chr() codes  at https://inventwithpython.com/chr

#Get the size of the terminal window.
CANVAS_WIDTH, CANVAS_HEIGHT = shutil.get_terminal_size()
'''We can't print to the last column on windows without it adding a nowlin automatically, 
...
while True:     #main program loop.
    ...
    if response == 'QUIT':
        ...
        print('''Enter W, A, S, and D characters to move the cursor and
                draw a line behind it as moves. for exampla, ddd
                draws a line going right and sssdddwwwaaa draws a box. 
                
                You can save your drawint to a text file by entering F. ''')
    ...
    for command in response:
        ...
        moves.append(command)   #Reconrd this moves.
        ...
        # If there's no set (cursorX, cursorY), and an empty set.
