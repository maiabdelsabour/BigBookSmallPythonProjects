...
print('''Factor Finder, by Al Sweigart ..........
    ...
    A number's factors are two numbers that, whwn multiplied with each 
    other, produce the number. For example, 2X13=26, so 2 and 13 are 
    factors of 26. 1X26=26, so 1 and 26 are also factor of 26. We
...
while True:     #Main program loop.
    print('Enter a positive whoel number to factor (or QUIT):')
    response = input('> ')
