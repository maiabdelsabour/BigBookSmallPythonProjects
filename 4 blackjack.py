...
def main():
        ...
        Rules:
            ...
            buy must hit exactly one more time begore standing.
        ...
        while True:
            ...
            while True:   #keep looping untill player stands or busts.
                ...
                if move == 'D':
                    #player is doubling down, they can increse their bet.
...
def getHandValue(cards):
    ...
    for i in range(numberOfAces):
        #If another can be added with busting, do so.
        if value+ 10 <= 21:
            value += 10
...
def getMove(playerHand, money):
    '''Asksthe player for their move and returns 'H' for hit, 'S' for stand, and 'D' for double down.'''

    while True: #keep looping untill the player enters a correct move.
        #Determine what moves the player can make.
        moves = ['(H)it', '(S)tand']

        #The player can double down on their first move, which we can tell because they'll have two cards.
        ...
        if move in ('H', 'S'):
            return move #player haas entered a valid move.
